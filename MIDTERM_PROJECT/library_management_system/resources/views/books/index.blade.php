...
<div class="container">
    ...
    <table>
        ...
        @forelse ($books as $book)
            <tr>
                ...
                <td class="action-links">
                    <a class="view-btn" href="{{ route('books.show', $book) }}">View</a>
                    <a class="edit-btn" href="{{ route('books.edit', $book) }}">Edit</a>
        ...
        @empty
            <tr><td colspan="7" style="text-align:center; color:#999;">No books found.</td></tr>
        @endforelse
        </tbody>
    </table>
